...
module.exports = async () => {
  ...
  if (command === "setup") {
    ...
    childProcess.execSync('git config --global user.email "matt@daemon.com"');
    childProcess.execSync('git config --global user.name "Matt Daemon"');
    childProcess.execSync('git commit -am "clean"');
