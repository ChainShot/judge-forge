...
const { translateToStandardResults } = require("./translateToStandardResults");
    ...
    childProcess.exec(
      ...
      async (err, stdout, stderr) => {
        ...
        if (jsonPart.length > 0) {
          ...
          const translatedResults = await translateToStandardResults(
            parsedJson
          );
          process.stdout.write(JSON.stringify(translatedResults));
        } else {
